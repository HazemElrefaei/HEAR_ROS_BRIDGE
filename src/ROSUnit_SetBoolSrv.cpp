...
bool(*ROSUnit_SetBoolSrv::callbackFunctionPointer[ROSUnit_capacity])(hear_msgs::set_bool::Request&, hear_msgs::set_bool::Response&){
...
bool ROSUnit_SetBoolSrv::srv_callback1(hear_msgs::set_bool::Request& req, hear_msgs::set_bool::Response& res) {
    BoolMsg t_msg;
    t_msg.data = req.data;
    _output_port_0->receiveMsgData(&t_msg);
    return true;
}
bool ROSUnit_SetBoolSrv::srv_callback2(hear_msgs::set_bool::Request& req, hear_msgs::set_bool::Response& res) {
    BoolMsg t_msg;
    t_msg.data = req.data;
    _output_port_1->receiveMsgData(&t_msg);
    return true;
}
bool ROSUnit_SetBoolSrv::srv_callback3(hear_msgs::set_bool::Request& req, hear_msgs::set_bool::Response& res) {
    BoolMsg t_msg;
    t_msg.data = req.data;
    _output_port_2->receiveMsgData(&t_msg);
    return true;
}
bool ROSUnit_SetBoolSrv::srv_callback4(hear_msgs::set_bool::Request& req, hear_msgs::set_bool::Response& res) {
    BoolMsg t_msg;
    t_msg.data = req.data;
    _output_port_3->receiveMsgData(&t_msg);
    return true;
}
bool ROSUnit_SetBoolSrv::srv_callback5(hear_msgs::set_bool::Request& req, hear_msgs::set_bool::Response& res) {
    BoolMsg t_msg;
    t_msg.data = req.data;
