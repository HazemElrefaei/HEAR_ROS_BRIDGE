...
private:
    ...
    static bool(*callbackFunctionPointer[ROSUnit_capacity])(hear_msgs::set_bool::Request&, hear_msgs::set_bool::Response&);
    static bool srv_callback1(hear_msgs::set_bool::Request&, hear_msgs::set_bool::Response&);//TODO refactor through templates
    ...
    static bool srv_callback5(hear_msgs::set_bool::Request&, hear_msgs::set_bool::Response&);
};